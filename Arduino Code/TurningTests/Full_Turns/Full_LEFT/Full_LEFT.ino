//This code will cause the BOEbot to turn LEFT for as long as it is on.
...
void loop() {
//In order to turn left, both wheels must turn clockwise
RightWheel.writeMicroseconds(FullClock);
LeftWheel.writeMicroseconds(FullClock);
}
